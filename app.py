...
def home_page():
    ...
    st.write("""
        Welcome to the Visualization Course! This course will take you through the fundamentals and advanced techniques
        of creating impactful visualizations. Let's make data look beautiful and insightful.
    """)
